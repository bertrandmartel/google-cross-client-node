...
(function() {
    ...
    app.User = Backbone.Model.extend({
        idAttribute: '_id',
        url: function() {
            return baseUrl + '/admin/users/' + this.id + '/';
        }
    });
    ...
    app.Delete = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/users/' + app.mainView.model.id + '/';
        }
    });
    ...
    app.Password = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/users/' + app.mainView.model.id + '/password/';
        },
        parse: function(response) {
            if (response.user) {
                app.mainView.model.set(response.user);
    ...
    app.RolesView = Backbone.View.extend({
        ...
        adminOpen: function() {
            location.href = baseUrl + '/admin/administrators/' + this.model.get('roles').admin._id + '/';
        },
        adminLink: function() {
            this.model.save({
        ...
        accountOpen: function() {
            location.href = baseUrl + '/admin/accounts/' + this.model.get('roles').account._id + '/';
        },
