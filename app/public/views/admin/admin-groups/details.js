...
(function() {
    ...
    app.AdminGroup = Backbone.Model.extend({
        idAttribute: '_id',
        url: function() {
            return baseUrl + '/admin/admin-groups/' + this.id + '/';
        }
    });
    ...
    app.Delete = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/admin-groups/' + app.mainView.model.id + '/';
        }
    });
    ...
    app.Permissions = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/admin-groups/' + app.mainView.model.id + '/permissions/';
        },
        parse: function(response) {
            if (response.adminGroup) {
                app.mainView.model.set(response.adminGroup);
            ...
            if (confirm('Are you sure?')) {
                this.model.destroy({
                    success: function(model, response) {
                        if (response.success) {
                            location.href = baseUrl + '/admin/admin-groups/';
                        } else {
