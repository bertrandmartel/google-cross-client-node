...
(function() {
    ...
    app.Account = Backbone.Model.extend({
        idAttribute: '_id',
        url: function() {
            return baseUrl + '/admin/accounts/' + this.id + '/';
        }
    });
    ...
    app.Delete = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/accounts/' + app.mainView.model.id + '/';
        }
    });
    ...
    app.Login = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/accounts/' + app.mainView.model.id + '/user/';
        },
        parse: function(response) {
            if (response.account) {
                app.mainView.model.set(response.account);
    ...
    app.Note = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/accounts/' + app.mainView.model.id + '/notes/' + (this.isNew() ? '' : this.id + '/');
        },
        parse: function(response) {
            if (response.account) {
                app.mainView.model.set(response.account);
    ...
    app.Status = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/accounts/' + app.mainView.model.id + '/status/' + (this.isNew() ? '' : this.id + '/');
        },
        parse: function(response) {
            if (response.account) {
                app.mainView.model.set(response.account);
            ...
            if (confirm('Are you sure?')) {
                this.model.destroy({
                    success: function(model, response) {
                        if (response.success) {
                            location.href = baseUrl + '/admin/accounts/';
                        } else {
