...
(function() {
    ...
    app.Admin = Backbone.Model.extend({
        idAttribute: '_id',
        url: function() {
            return baseUrl + '/admin/administrators/' + this.id + '/';
        }
    });
    ...
    app.Delete = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/administrators/' + app.mainView.model.id + '/';
        }
    });
    ...
    app.Login = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/administrators/' + app.mainView.model.id + '/user/';
        },
        parse: function(response) {
            if (response.admin) {
                app.mainView.model.set(response.admin);
    ...
    app.Groups = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/administrators/' + app.mainView.model.id + '/groups/';
        },
        parse: function(response) {
            if (response.admin) {
                app.mainView.model.set(response.admin);
    ...
    app.Permissions = Backbone.Model.extend({
        ...
        url: function() {
            return baseUrl + '/admin/administrators/' + app.mainView.model.id + '/permissions/';
        },
        parse: function(response) {
            if (response.admin) {
                app.mainView.model.set(response.admin);
            ...
            if (confirm('Are you sure?')) {
                this.model.destroy({
                    success: function(model, response) {
                        if (response.success) {
                            location.href = baseUrl + '/admin/administrators/';
                        } else {
    ...
    app.LoginView = Backbone.View.extend({
        ...
        userOpen: function() {
            location.href = baseUrl + '/admin/users/' + this.model.get('id') + '/';
        },
        userLink: function() {
            this.model.save({
